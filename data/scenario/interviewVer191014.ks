...
[glink  color="black"  storage="weblink.ks"  size="20"  text="掲示板に感想を書く"  target="*story"  y="300"  x="200"  ]
[glink  color="black"  storage="weblink.ks"  size="20"  text="Discardに投稿する"  target="*arita"  y="400"  x="200"  ]
