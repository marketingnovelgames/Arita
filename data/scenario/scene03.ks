...
[glink  color="black"  storage="scene03.ks"  size="20"  target="*A:「2300万円もの価値はないから」"  text="200万円もの価値はないから"  x="200"  y="150"  ]
[glink  color="black"  storage="scene03.ks"  size="20"  target="*B:「あの皿は使い道がないから」"  text="あのお皿は使いみちがないから"  x="200"  y="200"  ]
[glink  color="black"  storage="scene03.ks"  size="20"  target="*C：「あの皿の存在を伝えていないから」"  text="あのお皿の存在を伝えていないから"  x="200"  y="250"  ]
[glink  color="black"  storage="scene03.ks"  size="20"  target="*D：「あの皿は古すぎるから」"  text="あのお皿はふるすぎるから"  x="200"  y="300"  ]
[s  ]
*A:「2300万円もの価値はないから」
...
[glink  color="black"  storage="scene03.ks"  size="20"  target="*A:紹介するのを忘れてしまった？"  text="紹介するのを忘れてしまった？"  x="200"  y="150"  ]
[glink  color="black"  storage="scene03.ks"  size="20"  target="*B:あの皿は隠されていた？"  text="あの皿は隠されていた？"  x="200"  y="200"  ]
[tb_image_hide  ]
[s  ]
*A:紹介するのを忘れてしまった？
...
[glink  color="black"  storage="scene03.ks"  size="20"  text="「おじいちゃんを知ってもらいたい」"  target="*A:おじいちゃんを知ってもらいたい"  x="150"  y="100"  ]
[glink  color="black"  storage="scene03.ks"  size="20"  target="*B:大人をからかおうとしている"  text="「大人をからかおうとしている」"  x="150"  y="200"  ]
[s  ]
*A:おじいちゃんを知ってもらいたい
