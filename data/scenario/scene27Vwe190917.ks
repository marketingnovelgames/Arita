...
[glink  color="black"  storage="scene27Vwe190917.ks"  size="20"  text="目立つ場所にお皿をならべては？"  x="150"  y="50"  width="300"  height="30"  _clickable_img=""  target="*A_showup"  ]
[glink  color="black"  storage="scene27Vwe190917.ks"  size="20"  text="ブログに書いてみよう"  x="150"  y="150"  width="300"  height="30"  _clickable_img=""  target="*B:blogging"  ]
[glink  color="black"  storage="scene27Vwe190917.ks"  size="20"  text="宣伝を出そう"  x="150"  width="300"  height="30"  y="250"  _clickable_img=""  target="*C_promotion"  ]
[glink  color="black"  storage="scene27Vwe190917.ks"  size="20"  text="誰が買いそうか調べよう"  x="150"  width="300"  height="30"  y="350"  _clickable_img=""  target="*D_analytics"  ]
[s  ]
[cm  ]
*A_showup

[tb_eval  exp="f.programmer_point+=5"  name="programmer_point"  cmd="+="  op="t"  val="5"  val_2="undefined"  ]
[delay  speed="30"  ]
